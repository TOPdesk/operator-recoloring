/*
 * Code copied and adapted from https://codepen.io/sosuke/pen/Pjoqqp by Barrett Sonntag,
 * which in turn was based on https://stackoverflow.com/a/43960991/604861 by MultiplyByZer0.
 */

self.onmessage = (event) => {
  const solver = new Solver(event.data);
  console.log('incoming', event.data);
  
  self.postMessage(solver.solve())
}
